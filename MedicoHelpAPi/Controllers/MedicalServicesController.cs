...
namespace MedicoHelpAPi.Controllers
{
    ...
    public class MedicalServicesController : ControllerBase
    {
        ...
        {
            if (id != medicalService.Idservice)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<MedicalService>> PostMedicalService(MedicalService medicalService)
        {
            ...
            {
                if (MedicalServiceExists(medicalService.Idservice))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetMedicalService", new { id = medicalService.Idservice }, medicalService);
        }
        ...
        {
            return _context.MedicalService.Any(e => e.Idservice == id);
        }
    }
}
